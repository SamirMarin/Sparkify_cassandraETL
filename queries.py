...
select_table_queries = {"songs_in_session" :songs_in_session_test_select, "songs_per_user": songs_per_user_test_select, "users_per_song": users_per_song_test_select}
